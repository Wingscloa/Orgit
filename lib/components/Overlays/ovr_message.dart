...
class OverlayMessageMute extends StatefulOverlay {
  OverlayMessageMute({super.key});
  @override
  OverlayMessageMuteState createState() => OverlayMessageMuteState();
}

class OverlayMessageMuteState extends State<OverlayMessageMute> {
